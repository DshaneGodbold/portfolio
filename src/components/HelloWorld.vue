<template>
  <div>
   ...
   <img class="shane-profile-pic fade-in-fwd" alt="" src="@/assets/portfolio-pic.jpg"/>
         <h1>Welcome to D'Shane's Portfolio!</h1>
         <p class="text-focus-in">  
           Welcome to my <b>Domain!</b> Check me out I hope you like it~~ ❤️
    </p>
    <h3 class="Google text-focus-in">Google</h3>
    <ul  class="pulsate-bck" >
      <li><a href="https://Dshanegodbold@gmail.com" target="_blank" rel="noopener">Gmail</a></li>
         </ul>
    <h3 class="text-focus-in">Github</h3>
    <ul class="pulsate-bck">
      <li><a  href="https://github.com/DshaneGodbold" target="_blank" rel="noopener">D'Shane's Github</a></li>
    </ul>
        <h3 class="text-focus-in">Resume</h3>
    <ul class="pulsate-bck">
      <li><a href="../assets/files/Dshane-Godbold.pdf"
...
.fade-in-fwd{
  animation:fade-in-fwd 1.5s cubic-bezier(.39,.575,.565,1.000) both}
